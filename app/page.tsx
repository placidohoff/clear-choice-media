      ...
      <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-[#050d14]/90 backdrop-blur-md">
        <div className="mx-auto flex max-w-[1400px] items-center justify-between gap-3 px-4 py-3 sm:gap-8 sm:px-6 lg:px-10 lg:py-4">
          ...
          <div className="ml-auto flex items-center gap-5">
            ...
            <Link
              href="/admin/login"
              className="hidden rounded-full border border-[#7cd3ff]/40 bg-[#7cd3ff]/10 px-4 py-2.5 text-[10px] font-bold uppercase tracking-[0.18em] text-[#7cd3ff] transition duration-200 hover:-translate-y-0.5 hover:bg-[#7cd3ff]/20 sm:inline-flex sm:px-5 sm:py-3 sm:text-[11px]"
            >
              Login
            </Link>
          </div>
        ...
        <div className="border-t border-white/10 bg-[#050d14] px-4 py-3 lg:hidden">
